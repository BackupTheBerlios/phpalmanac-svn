...
*/
include_once 'Savant3/Error.php';
include_once 'Savant3/Filter.php';
include_once 'Savant3/Plugin.php';
...
* 
* @todo Unit test for template inclusion
* 
* @todo Unit test for plugin extensions
* 
* @todo Rename 'safe' back to 'modify'? or 'print'?
* 
* @todo Allow for defined 'modify' callback sets?
* 
...
class Savant3 {
	...
	*/
	...
	const ERR_UNKNOWN  = -1;
	const ERR_COMPILER = -2;
	const ERR_PLUGIN   = -3;
	const ERR_TEMPLATE = -4;
	...
	*/
	...
	protected function &conf($key = null)
	{
		...
		if (! isset($conf)) {
			$conf = array(
				'i18n' => array(
					Savant3::ERR_UNKNOWN    => 'unknown error',
					Savant3::ERR_COMPILER   => 'compiler callback returned an error',
					Savant3::ERR_PLUGIN     => 'plugin class file not found',
					Savant3::ERR_TEMPLATE   => 'template source file not found',
				),
				'template_path' => array(),
				'resource_path' => array(),
				'error_type'    => null,
	...
	*/
	...
	public function fetch($tpl = null)
	{
		...
		if (! $result || $this->isError($result)) {
			...
			// yes.  execute the template script.  move the path to the 
			// script outside the local namespace, then clean up the
			// namespace, to avoid variable name conflicts.
			...
			// reset the fetch script value, get outer buffer, and return.
	...
	* 
	* @throws object An error object with a Savant3::ERR_TEMPLATE code.
	* 
	*/
	...
	*/
	...
	/**
	* 
	* Adds a filter callback to the stack of filters.
	* 
	* @access protected
	* 
	* @param string The template file to include.
	...
	* @access public
	* 
	* @param int $code A Savant3::ERR_* constant.
	* 
